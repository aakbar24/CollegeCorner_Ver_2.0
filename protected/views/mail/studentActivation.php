...
<div>
    ...
    <p>Please <?php echo '<a href=' . Yii::app()->getBaseUrl(true) .'/register/verify?hash=' . $hash . '><strong>click this link in order to activate your account.</strong></a>'; ?>. You will be re-directed to the College Cornerstone log-in page, and your account will become active. When you activate your account, you will be able to log into the service by using your <strong>Username / E-Mail and Password</strong>.</p>
