...
class TbActiveForm extends CActiveForm
{
	...
	public function tagitRow($model, $attribute, $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_TAGIT, $model, $attribute, null, $htmlOptions);
	}
	
	public function tagitField($model, $attribute, $widgetOptions, $htmlOptions = array())
	{
		return Yii::app()->controller->widget('bootstrap.widgets.TbTagit', array(
				'model' => $model,
				'attribute' => $attribute,
