...
<?php if (!empty($this->area)) echo "<h1>($this->area)</h1>"; ?>
        ...
        array(
            ...
            'buttons' => array
                ...
                'disable' => array
                    ...
                    'label' => 'Disable',
                    'icon' => 'remove-sign',
                    'url' => 'Yii::app()->createUrl("users/email", array("id"=>$data->post_item_id))',
                ),
            ),
        ),
//        array(
//            'class' => 'JToggleColumn',
//            'name' => 'postItem.is_active', // boolean model attribute (tinyint(1) with values 0 or 1)
//            'header' => false,
//            'filter' => array('0' => 'No', '1' => 'Yes'), // filter
//            'labeltype'=>'image',
//            'checkedButtonTitle'=>'Active', // tooltip
//                                        'uncheckedButtonTitle'=>'Disabled', 
...
//        ),
        array(
            ...
            'name' => 'postItem.is_active',
            'value' => 0,
            'checkedButtonLabel' => 'Active',
            'uncheckedButtonLabel' => 'Disabled',
            'header' => false
        ),
    ),
));
