...
class UserStats extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('num_logins', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('user_id, num_logins', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		...
		return array(
			'user_id' => Yii::t('model','userStats.user_id'),
			'num_logins' => Yii::t('model','userStats.num_logins'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('num_logins',$this->num_logins,true);
